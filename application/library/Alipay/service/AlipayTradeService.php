 ...
 * Time: 下午2:09
 */
require_once dirname( dirname(__FILE__) ).DIRECTORY_SEPARATOR.'AopSdk.php';
require_once dirname( dirname(__FILE__) ).DIRECTORY_SEPARATOR.'model/result/AlipayF2FPayResult.php';
require_once dirname( dirname(__FILE__) ).DIRECTORY_SEPARATOR.'model/result/AlipayF2FQueryResult.php';
require_once dirname( dirname(__FILE__) ).DIRECTORY_SEPARATOR.'model/result/AlipayF2FRefundResult.php';
require_once dirname( dirname(__FILE__) ).DIRECTORY_SEPARATOR.'model/result/AlipayF2FPrecreateResult.php';
require_once dirname( dirname(__FILE__) ).DIRECTORY_SEPARATOR.'model/builder/AlipayTradeQueryContentBuilder.php';
require_once dirname( dirname(__FILE__) ).DIRECTORY_SEPARATOR.'model/builder/AlipayTradeCancelContentBuilder.php';
