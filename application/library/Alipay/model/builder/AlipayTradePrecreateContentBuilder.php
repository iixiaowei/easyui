...
require_once dirname(__FILE__).'/GoodsDetail.php';
require_once dirname(__FILE__).'/ExtendParams.php';
require_once dirname(__FILE__).'/RoyaltyDetailInfo.php';
require_once dirname(__FILE__).'/ContentBuilder.php';
